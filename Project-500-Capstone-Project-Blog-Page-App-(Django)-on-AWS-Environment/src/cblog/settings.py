...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cwinayf9bpxf.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesfatihblog' # please enter your s3 bucket name
