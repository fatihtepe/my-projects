# ProjectK-007 : Web Page Application (Postgresql-Nodejs-React) deployed on EC2's with Ansible, Docker and Nginx Proxy Server
...
|----todo-app-perm (folder)  (Nodejs and React files)
...
![Todo Web Page](img/todo_web.png)
