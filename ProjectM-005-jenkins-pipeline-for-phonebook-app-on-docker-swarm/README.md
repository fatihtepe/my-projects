# ProjectM-005: Jenkins Pipeline for Dockerized Phonebook Application (Python Flask & MySQL) Deployed on Docker Swarm
...
```text
ProjectM-005-jenkins-pipeline-for-phonebook-app-on-docker-swarm (folder)
|
|----readme.md                  # (Definition of the project)
|----phonebook-cfn-template.yml # (Cloudformation template)
|----Dockerfile
|----docker-compose.yml
|----init.sql                   # (SQL statements to initialize db)
|----jenkins-cfn-template.yml   # (Cloudformation template for Jenkins Server)
|----Jenkinsfile
|----app
...
![Phonebook App Search Page](./img/add.png)
